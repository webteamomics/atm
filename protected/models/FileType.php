...
/**
 * This is the model class for table "dp0_file_type".
 *
 * The followings are the available columns in table 'dp0_file_type':
...
class FileType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iddp0_file_type, name', 'safe', 'on'=>'search'),
		);
	}
